                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-6 col-lg-6 col-md-4 col-sm-8 align-self-center">
                            <div class="map-index">
                                <svg id="map" class="SVG_OPTIMIZE" xmlns="http://www.w3.org/2000/svg" version="1.1" viewbox="0 0 1000 1000" baseprofile="tiny" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width=".5">
                                    <g id="features">
