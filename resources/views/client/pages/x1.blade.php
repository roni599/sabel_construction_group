...
<head>
    ...
    <title>Dr. M. A. Wazed Miah IICT Building SUST</title>
    <!-- FAVICON -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="pro-wrapper">
                                        <div class="detail-wrapper-body">
                                            <div class="listing-title-bar">
                                                <h3>Dr. M. A. Wazed Miah IICT Building SUST</h3>
                                                <div class="mt-0">
                                                    <a href="#listing-location" class="listing-address">
                                                        <i class="fa fa-map-marker pr-2 ti-location-pin mrg-r-5"></i>Sylhet
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div id="listingDetailsSlider" class="carousel listing-details-sliders slide mb-30">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="active item carousel-item" data-slide-number="0">
                                            <img src="/Client/images/ss-projects/5.jpg" class="img-fluid" alt="slider-listing">
                                        </div>
                                        <div class="item carousel-item" data-slide-number="1">
                                            <img src="/Client/images/ss-projects/5-1.jpg" class="img-fluid" alt="slider-listing">
                                        </div>
                                        <div class="item carousel-item" data-slide-number="2">
                                            <img src="/Client/images/ss-projects/5-2.jpg" class="img-fluid" alt="slider-listing">
                                        </div>
                                        <div class="item carousel-item" data-slide-number="2">
                                            <img src="/Client/images/ss-projects/5-3.jpg" class="img-fluid" alt="slider-listing">
                                        </div>
                                    ...
                                    <ul class="carousel-indicators smail-listing list-inline">
                                        <li class="list-inline-item active">
                                            <a id="carousel-selector-0" class="selected" data-slide-to="0" data-target="#listingDetailsSlider">
                                                <img src="/Client/images/ss-projects/5.jpg" class="img-fluid" alt="listing-small">
                                            </a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a id="carousel-selector-1" data-slide-to="1" data-target="#listingDetailsSlider">
                                                <img src="/Client/images/ss-projects/5-1.jpg" class="img-fluid" alt="listing-small">
                                            </a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a id="carousel-selector-2" data-slide-to="2" data-target="#listingDetailsSlider">
                                                <img src="/Client/images/ss-projects/5-2.jpg" class="img-fluid" alt="listing-small">
                                            </a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a id="carousel-selector-2" data-slide-to="2" data-target="#listingDetailsSlider">
                                                <img src="/Client/images/ss-projects/5-3.jpg" class="img-fluid" alt="listing-small">
                                            </a>
                                        </li>
                                    </ul>
                                    <!-- main slider carousel items -->
                                ...
                                <div class="blog-info details mb-30">
                                    ...
                                    <p class="mb-3">Construction of Remaining Portion 4th to 9th Floor of Dr. M. A. Wazed Miah IICT Building in SUST Sylhet.</p>
                                </div>
                            </div>
                        </div>
                        <div class="single homes-content details mb-30 d-flex flex-column">
                            ...
                            <ul class="homes-list clearfix">
                                <li>
                                    ...
                                    <span class="det">Shahjalal University of Science and Technology (SUST), Sylhet. </span>
                                </li>
                                <li>
                                    <span class="font-weight-bold mr-1">Type of work Performed :</span>
                                    <span class="det">10 Storied Frame Structured Building.</span>
                                </li>
                                <li>
                                    <span class="font-weight-bold mr-1">Date of Completion :</span>
                                    <span class="det">30.11.2023</span>
                                </li>
                                <li>
                                    <span class="font-weight-bold mr-1">Value of Contract :</span>
                                    <span class="det">Tk. 41,36,40,000.720</span>
                                </li>
                            </ul>                            
                        </div>
