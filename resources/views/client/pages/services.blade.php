...
<body class="inner-pages shop int_dark_bg">
    <!-- Wrapper -->
    <div id="wrapper">
                ...
                <div class="news-wrap">
                    <div class="row">
                        <div class="col-lg-4 col-md-12 col-xs-12 ">
                            <a href="#">
                                <img src="Client/images/services/Power Plant.jpg" alt="">
                            </a>
                            <div class="blog-info">
                                <h3 class="text-center">Power Plant</h3>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-12 col-xs-12 ">
                            <a href="#">
                                <img src="Client/images/services/Building.png" alt="">
                            </a>
                            <div class="blog-info">
                        ...
                        <div class="col-lg-4 col-md-12 col-xs-12 ">
                            <a href="#">
                                <img src="Client/images/services/Factory, Warehouse & Workshop.jpg" alt="">
                            </a>
                            <div class="blog-info">
                                <h3 class="text-center">Factory, Warehouse & Workshop</h3>
                            </div>
                        </div>
                    </div>
                </div>
                    <div class="row pt-5">
                        <div class="col-lg-4 col-md-12 col-xs-12 ">
                            <a href="#">
                                <img src="Client/images/services//Effluent Treatment Plant.webp" alt="">
                            </a>
                            <div class="blog-info">
                                <h3 class="text-center">Effluent Treatment Plant</h3>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-12 col-xs-12 ">
                            <a href="#">
                                <img src="Client/images/services/Land Development & Landscaping.jpg" alt="">
                            </a>
                            <div class="blog-info">
                                <h3 class="text-center">Land Development & Landscaping</h3>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-12 col-xs-12 ">
                            <a href="#">
                                <img src="Client/images/services/Airport Terminal and Apron.jpg" alt="">
                            </a>
                            <div class="blog-info">
                                <h3 class="text-center">Airport Terminal and Apron</h3>
                            </div>
                        </div>
                    </div>
                <div class="row pt-5">
                        <div class="col-lg-4 col-md-12 col-xs-12 ">
                            <a href="#">
                                <img src="Client/images/services/Hydraulic Structure.jpg" alt="">
                            </a>
                            <div class="blog-info">
                                <h3 class="text-center">Hydraulic Structure</h3>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-12 col-xs-12 ">
                            <a href="#">
                                <img src="Client/images/services/Steel Structure.jpg" alt="">
                            </a>
                            <div class="blog-info">
                                <h3 class="text-center">Steel Structure</h3>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-12 col-xs-12 ">
                            <a href="#">
                                <img src="Client/images/services/Roads & Bridges.jpg" alt="">
                            </a>
                            <div class="blog-info">
                                <h3 class="text-center">Roads & Bridges</h3>
                            </div>
                        </div>
                    </div>
            </div>
